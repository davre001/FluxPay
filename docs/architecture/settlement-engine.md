...
Creator submits deliverable
        │
        ▼
  Venice AI scores the work
        │
        ▼
   Score ≥ minimum? ──── No ──→ Rejected (no payment)
        │
       Yes
        │
        ▼
   Release (score × amount) in USDC
        │
        ▼
   Brand's MetaMask permission (ERC-7715/7710)
        │
        ▼
   1Shot relays (gas paid in USDC)
        │
        ▼
   Creator paid 💸
```
